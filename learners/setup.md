...
Teaching is hands-on, and to follow this lesson
...
* To install RStudio:
    * *On a University computer*: Open 'Software Center', search for RStudio, and install.
    * *On a personal computer*: Go to the [RStudio download page](https://www.rstudio.com/products/rstudio/download/#download) and select 'Download RStudio Desktop for Windows'.
...
* To install RStudio:
    * *On a University computer*: Open 'Self Service', search for RStudio, and install.
    * *On a personal computer*: Go to the [RStudio download page](https://www.rstudio.com/products/rstudio/download/#download) and select 'Download RStudio Desktop for Mac'.
* Once it's installed, open RStudio to make sure it works and you don't get any error messages.
...
To update RStudio to the latest version, use the method you used to originally download and install RStudio to download and install the latest version.
